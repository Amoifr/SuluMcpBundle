...
[Streamable HTTP](https://modelcontextprotocol.io/specification/2025-03-26/basic/transports) — a single endpoint at `/_mcp` that accepts JSON-RPC over HTTP POST and optionally streams responses with SSE. The legacy HTTP+SSE transport is not used.
