...
- **Global scope**: `/Users/johannes/Development/ai/sulu-mcp/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/johannes/Development/ai/sulu-mcp/.claude/notes/`)
...
2. Glob `/Users/johannes/Development/ai/sulu-mcp/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/johannes/Development/ai/sulu-mcp/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/johannes/Development/ai/sulu-mcp/.claude/notes/` — works in any directory
