...
- Usage: Reference from command with `@/Users/johannes/Development/ai/sulu-mcp/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/johannes/Development/ai/sulu-mcp/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/johannes/Development/ai/sulu-mcp/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
