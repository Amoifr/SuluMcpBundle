...
namespace Sulu\Bundle\McpBundle\Tests\Unit\Metadata;
...
use Sulu\Bundle\McpBundle\Metadata\ExtensionFieldsResource;

#[CoversClass(ExtensionFieldsResource::class)]
final class ExtensionFieldsResourceTest extends TestCase
{
    public function testReturnsSeoAndExcerptFieldsWithStrippedNames(): void
    {
        ...
        $resource = new ExtensionFieldsResource($provider);
