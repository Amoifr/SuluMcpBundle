...
use Sulu\Bundle\McpBundle\Capabilities\Tool\Block\BlockAddTool;
...
use Sulu\Bundle\McpBundle\Capabilities\Tool\Block\BlockReorderTool;
use Sulu\Bundle\McpBundle\Capabilities\Tool\Block\BlockUpdateTool;
...
final class ToolPermissionGoldenTest extends TestCase
{
    ...
    {
        $root = __DIR__.'/../../../../src/Capabilities/Tool';
        $srcRoot = __DIR__.'/../../../../src';
